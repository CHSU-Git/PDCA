<%@ Page Title="" Language="C#" MasterPageFile="~/PDCAField.Master" AutoEventWireup="true" CodeBehind="PDCAFieldtest.aspx.cs" Inherits="PDCA_ASPX.PDCAFieldtest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width: 1200px; background-color: lightgrey;">
                ...
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            <asp:Label runat="server" ID="lblHeader" ForeColor="White" />
                        </asp:TableCell><asp:TableCell runat="server" align="center">
                            <asp:Label runat="server" ID="lblErrorHeader" BackColor="White" ForeColor="Red" Text="Some error" />
        ...
        <asp:Panel ID="pnlHeader" runat="server" BorderWidth="1" BorderColor="Black" HorizontalAlign="Left">
            <asp:Table ID="Table11" runat="server" CellPadding="20">
            ...
            <asp:Table ID="Table11a" runat="server">
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Label ID="Label1" runat="server" Font-Bold="true" Text="Name:  "></asp:Label>
                    </asp:TableCell><asp:TableCell>
                        <asp:TextBox runat="server" Text="" ID="txtOriginatorName" Width="500px"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left">
                        ...
                        <asp:TextBox ID="txtTitle" runat="server" Height="20px" Width="1000px"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left">
                        ...
                        <asp:TextBox ID="txtDescription" runat="server" Height="50px" Width="1000px" TextMode="MultiLine"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left">
                        ...
                        <asp:TextBox ID="txtDepartment" runat="server" Height="20px" Width="1000px"></asp:TextBox>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        ...
        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender10" runat="server" TargetControlID="pnlHeader"
            CollapsedSize="0" ExpandedSize="215"
            ExpandedText="Assessment and Continuous Quality Improvement Form"
            CollapsedText="Assessment and Continuous Quality Improvement Form" TextLabelID="lblHeader" ImageControlID="Image11"
            ExpandedImage="~/images/collapse.jpg" CollapsedImage="~/images/expand_blue.jpg"
            ExpandControlID="Image11"
            CollapseControlID="Image11" Collapsed="false" SuppressPostBack="false" />
        <hr />
    </div>
    ...
    <div style="width: 1200px; background-color: lightgrey;">
                ...
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            ...
                            <asp:Label runat="server" ID="lblErrorSubjectofAssessment" BackColor="White" ForeColor="Red" Text="Some error" />
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/PDCAFieldtest.aspx" Target="_top">
                                <asp:Image ID="Image13" runat="server" ImageUrl="~/images/arrowupred.jpg" Height="25px" Width="25px" />
                            </asp:HyperLink>
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left" Width="100%">
                        <div style="background: white;">
                            <asp:TextBox ID="txtSubjectOfAssessmentExamples" runat="server" Height="182px" Width="1000px" BackColor="White"></asp:TextBox>
        ...
        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender11" runat="server" TargetControlID="pnlSubjectofAssessment"
            CollapsedSize="0" ExpandedSize="270"
    ...
    <div style="width: 1200px; background-color: lightgrey;">
        <asp:Panel runat="server" ID="panel12" HorizontalAlign="Center">
            <div style="font-weight: bold; background-color: maroon;">
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            <asp:Label runat="server" ID="Label10" ForeColor="White" Text="Results" />
                        </asp:TableCell><asp:TableCell runat="server" HorizontalAlign="center">
                            <asp:Label runat="server" ID="lblErrorSurveyResults" BackColor="White" ForeColor="Red" Text="Some error" />
                        </asp:TableCell><asp:TableCell align="right" Width="100px" runat="server">
                            <asp:CheckBox ID="ckSurveyResultsNotApplicable" runat="server" Text="N/A" ForeColor="White" />
                        </asp:TableCell><asp:TableCell align="center" Width="100px" runat="server">
                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/PDCAFieldtest.aspx" Target="_top">
        ...
        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender12" runat="server" TargetControlID="pnlSurveyResults"
            ...
            ExpandedText="Survey Results"
            CollapsedText="Survey Results" TextLabelID="Label10" ImageControlID="Image12"
            ExpandedImage="~/images/collapse.jpg" CollapsedImage="~/images/expand_blue.jpg"
    ...
    <div style="width: 1200px; background-color: lightgrey;">
                ...
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            ...
                            <asp:Label runat="server" ID="lblErrorAssessments" BackColor="White" ForeColor="Red" Text="Some error" />
                        </asp:TableCell><asp:TableCell align="right" Width="100px" runat="server">
                            <asp:CheckBox ID="ckAssessmentsNotApplicable" runat="server" Text="N/A" ForeColor="White" />
                        </asp:TableCell><asp:TableCell align="center" Width="100px" runat="server">
                            <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/PDCAFieldtest.aspx" Target="_top">
        ...
        <asp:Panel ID="pnlAssessments" runat="server" BorderWidth="1" BorderColor="Black" HorizontalAlign="Left">
            <asp:Table ID="Table2" runat="server" CellPadding="10" CellSpacing="5">
                ...
                <asp:TableRow HorizontalAlign="Left">
                    <asp:TableCell HorizontalAlign="Left">
                        <div style="background: white;">
                            <asp:TextBox ID="txtAssessmentName" runat="server" Height="182px" Width="1000px"></asp:TextBox>
                        </div>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        ...
        <asp:Panel ID="pnlStrengths" runat="server" BorderWidth="1" BorderColor="Black" HorizontalAlign="Left">
            <asp:Table ID="Table3" runat="server" CellPadding="10" CellSpacing="5">
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left">
                        <div style="background: white;">
                            <asp:TextBox ID="txtStrengths" runat="server" Height="182px" Width="1000px"></asp:TextBox>
                        </div>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
    ...
    <div style="width: 1200px; background-color: lightgrey;">
                ...
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            ...
                            <asp:Label runat="server" ID="lblErrorInsights" BackColor="White" ForeColor="Red" Text="Some error" />
                        </asp:TableCell><asp:TableCell align="right" Width="100px" runat="server">
                            <asp:CheckBox ID="ckInsightsNotApplicable" runat="server" Text="N/A" ForeColor="White" />
                        </asp:TableCell><asp:TableCell align="center" Width="100px" runat="server">
                            <asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/PDCAFieldtest.aspx" Target="_top">
        ...
        <asp:Panel ID="pnlInsights" runat="server" BorderWidth="1" BorderColor="Black" HorizontalAlign="Left">
            <asp:Table ID="Table4" runat="server" CellPadding="10" CellSpacing="5">
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left">
                        <div style="background: white;">
                            <asp:TextBox ID="txtInsights" runat="server" Height="182px" Width="1000px"></asp:TextBox>
                        </div>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
    ...
    <div style="width: 1200px; background-color: lightgrey;">
                ...
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            ...
                            <asp:Label runat="server" ID="lblErrorAreasForImprovement" BackColor="White" ForeColor="Red" Text="Some error" />
                        </asp:TableCell><asp:TableCell align="right" Width="100px" runat="server">
                            <asp:CheckBox ID="ckAreasForImprovementNotApplicable" runat="server" Text="N/A" ForeColor="White" />
                        </asp:TableCell><asp:TableCell align="center" Width="100px" runat="server">
                            <asp:HyperLink ID="HyperLink6" runat="server" NavigateUrl="~/PDCAFieldtest.aspx" Target="_top">
        ...
        <asp:Panel ID="pnlAreasForImprovement" runat="server" BorderWidth="1" BorderColor="Black" HorizontalAlign="Left">
            <asp:Table ID="Table5" runat="server" CellPadding="10" CellSpacing="5">
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left">
                        <div style="background: white;">
                            <asp:TextBox ID="txtAreasForImprovement" runat="server" Height="182px" Width="1000px"></asp:TextBox>
                        </div>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
    ...
    <div style="width: 1200px; background-color: lightgrey;">
            ...
            <asp:Table ID="Table15" runat="server" Width="100%">
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server" Width="50%">
                        ...
                        <asp:Table ID="Table6" runat="server" CellPadding="0" CellSpacing="5" Width="100%">

                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Label ID="Label34" runat="server" Text="Plan" BackColor="Maroon" Font-Bold="true" ForeColor="White"></asp:Label>
                                </asp:TableCell>
                                <asp:TableCell runat="server" align="center" HorizontalAlign="Center">
                                    <asp:Label runat="server" ID="lblErrorPlan" BackColor="White" ForeColor="Red" Text="Some error" />
                                </asp:TableCell>
                                <asp:TableCell align="right" Width="100px" runat="server">
                                    <asp:CheckBox ID="ckPlanNotApplicable" runat="server" Text="N/A" ForeColor="Black" />
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                    ...
                    </asp:TableCell><asp:TableCell runat="server" Width="50%">

                        <asp:Table ID="Table16" runat="server" CellPadding="0" CellSpacing="5" Width="100%">
                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Label ID="Label35" runat="server" Text="Do" BackColor="Maroon" Font-Bold="true" ForeColor="White"></asp:Label>
                                </asp:TableCell>
                                <asp:TableCell runat="server" align="center" HorizontalAlign="Center">
                                    <asp:Label runat="server" ID="lblErrorDo" BackColor="White" ForeColor="Red" Text="Some error" />
                                </asp:TableCell><asp:TableCell align="right" Width="100px" runat="server">
                                    <asp:CheckBox ID="ckDoNotApplicable" runat="server" Text="N/A" ForeColor="Black" />
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="3">
        ...
        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender5" runat="server" TargetControlID="pnlPlan"
            CollapsedSize="0" ExpandedSize="250"
            ExpandedText="Plan"
            CollapsedText="Plan" TextLabelID="Label12" ImageControlID="Image6"
            ExpandedImage="~/images/collapse.jpg" CollapsedImage="~/images/expand_blue.jpg"
    ...
    <div style="width: 1200px; background-color: lightgrey;">
                ...
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            ...
                            <asp:HyperLink ID="HyperLink9" runat="server" NavigateUrl="~/PDCAFieldtest.aspx" Target="_top">
            ...
            <asp:Table ID="Table17" runat="server" Width="100%">
                <asp:TableRow runat="server">
                    <asp:TableCell runat="server" Width="50%">
                        ...
                        <asp:Table ID="Table8" runat="server" CellPadding="10" CellSpacing="5" Width="100%">
                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Label ID="Label15" runat="server" Text="Check" BackColor="Maroon" Font-Bold="true" ForeColor="White"></asp:Label>
                                </asp:TableCell>
                                <asp:TableCell runat="server" align="center" HorizontalAlign="Center">
                                    <asp:Label runat="server" ID="lblErrorCheck" BackColor="White" ForeColor="Red" Text="Some error" />
                                </asp:TableCell>
                                <asp:TableCell align="right" Width="100px" runat="server">
                                    <asp:CheckBox ID="ckCheckNotApplicable" runat="server" Text="N/A" ForeColor="Black" />
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                        ...
                        <asp:Table ID="Table9" runat="server" CellPadding="10" CellSpacing="5" Width="100%">
                            <asp:TableRow>
                                <asp:TableCell>
                                    <asp:Label ID="Label21" runat="server" Text="Additional Comments" BackColor="Maroon" Font-Bold="true" ForeColor="White"></asp:Label>
                                </asp:TableCell>
                                <asp:TableCell runat="server" align="center" HorizontalAlign="Center">
                                    <asp:Label runat="server" ID="lblErrorAdditionalComments" BackColor="White" ForeColor="Red" Text="Some error" />
                                </asp:TableCell>
                                <asp:TableCell align="right" Width="100px" runat="server">
                                    <asp:CheckBox ID="ckAdditionalCommentsNotApplicable" runat="server" Text="N/A" ForeColor="Black" />
                                </asp:TableCell>
                            </asp:TableRow>
                            <asp:TableRow>
                                <asp:TableCell ColumnSpan="3">
        ...
        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender7" runat="server" TargetControlID="pnlCheck"
            CollapsedSize="0" ExpandedSize="250"
            ExpandedText="Check"
            CollapsedText="Check" TextLabelID="Label18" ImageControlID="Image8"
            ExpandedImage="~/images/collapse.jpg" CollapsedImage="~/images/expand_blue.jpg"
    ...
    <div style="width: 1200px; background-color: lightgrey;">
                ...
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            ...
                            <asp:Label runat="server" ID="lblErrorReport" BackColor="White" ForeColor="Red" Text="Some error" />
                        </asp:TableCell><asp:TableCell align="right" Width="100px" runat="server">
                            <asp:CheckBox ID="ckReportNotApplicable" runat="server" Text="N/A" ForeColor="White" />
                        </asp:TableCell><asp:TableCell align="center" Width="100px" runat="server">
                            <asp:HyperLink ID="HyperLink11" runat="server" NavigateUrl="~/PDCAFieldtest.aspx" Target="_top">
        ...
        <asp:Panel ID="pnlReport" runat="server" BorderWidth="1" BorderColor="Black" HorizontalAlign="Left">
            <asp:Table ID="Table10" runat="server" CellPadding="10" CellSpacing="5">
                ...
                <asp:TableRow>
                    <asp:TableCell HorizontalAlign="Left">
                        <div style="background: white;">
                            <asp:TextBox ID="txtReport" runat="server" Height="182px" Width="1000px"></asp:TextBox>
                        </div>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
    ...
    <div style="width: 1200px; background-color: lightgrey;">
                ...
                <asp:Table runat="server"
                    ...
                    <asp:TableRow>
                        <asp:TableCell runat="server" Font-Size="Larger" align="left">
                            ...
                            <asp:HyperLink ID="HyperLink12" runat="server" NavigateUrl="~/PDCAFieldtest.aspx" Target="_top">
        ...
        <asp:Panel ID="pnlAccreditationStandards" runat="server" BorderWidth="1" BorderColor="Black" HorizontalAlign="Left">
            <asp:Table ID="Table14" runat="server" CellPadding="10" CellSpacing="5">
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Label ID="Label26" runat="server" Text="4"></asp:Label>
                    </asp:TableCell><asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Label ID="Label30" runat="server" Text="2"></asp:Label>
                    </asp:TableCell><asp:TableCell>
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:Label ID="Label32" runat="server" Text="4"></asp:Label>
                    </asp:TableCell><asp:TableCell>
