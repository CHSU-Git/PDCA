...
namespace PDCA_ASPX
{
    public partial class PDCAEdit : System.Web.UI.Page
    {
            ...
            if (fuPDCADocument.HasFile)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        string sql1 = "PDCADocuments_Insert ";
                        sql1 += ", @pdcaid=" + this.txtPDCAID.Text;
                        sql1 += ", @FileName='" + PDCAFile + "'";
                        sql1 += ", @Title ='" + this.txtDocumentTitle.Text + "'";
                        sql1 += ", @Description='" + this.txtDocumentDescription.Text + "'";
                        sql1 += ", @insertedby ='" + userName + "'";
